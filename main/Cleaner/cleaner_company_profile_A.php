...
<div class="grid">
		...
		<div class="row space-top space-bot">
			...
			<div class="c10" style="text-align:center;margin-top:50px;margin-bottom:130px;">
				<h1> Halimah Cleaning Sdn. Bhd </h1>
				<div class="pageline">
				...
				<form action="" method="post">	
						...
						<label>
						<img src="image/c4.png" style="border-bottom: 5px solid #eee; text-align:center;" width="300" height="300" alt="" name="A"/>
						</label>
					
	<?php
	 
	 $result = mysqli_query($con, "SELECT * FROM cleaner WHERE cleaner_username ='cleaner4'");
