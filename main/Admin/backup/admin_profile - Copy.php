...
include("connectionDB.php");
	...
	$delete=$_POST['delete'];
		 ...
		 else
		 {
			...
			$Qdelete=mysql_query("Delete FROM admin WHERE admin_ID IN (".$impid.")");
			if(isset($Qdelete))
			{
			?>
			<script>
...
<div class="grid">
		...
		<div class="row">
			...
			<div class="c3">
				<div class="leftsidebar">
					<h2 class="title stresstitle">Admin Profile Picture</h2>
					<hr class="hrtitle">
					<img src="Image/team1.jpeg" class="imgOpa teamimage" alt="">
					<div class="teamdescription">
						<h1>Shafinaz Sanimi</h1>
	...
	?>
		<tr>
			<td><input type="checkbox" name="delete[]" value="<?php echo $row["admin_ID"]; ?>">
			<td><input type="text" name="ID" size="15" value="<?php echo $row["admin_ID"]; ?>"  readonly  >
			<td><input type="text" name="Name" size="20" value="<?php echo $row["admin_name"]; ?>" readonly>
			<td><input type="text" name="Password" value="<?php echo $row["admin_password"]; ?>" size="20" readonly>
		</tr>
	<?php
			}
    ?>	
		</table> <pre>
		<center> <a href="popupex.html" onclick="return popitup('AddAdminProfile.php')" type="popup"> <button type="submit" name="add" value="Add"> Add </button> <a href="popupex.html" onclick="return popitup('UpdateAdminProfile.php')" type="popup"> <button type="submit" name="update"  value="Update"> Update </button> </a> <button type="submit" name="del"  value="Delete"> Delete </button> </center>
		</pre>
