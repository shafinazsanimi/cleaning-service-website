...
include("connectionDB.php");
	...
	$delete=$_POST['delete'];
		 ...
		 else
		 {
			...
			$Qdelete=mysql_query("Delete FROM customer WHERE customer_id IN (".$impid.")");
			if(isset($Qdelete))
			{
			?>
			<script>
...
<div class="grid">
		...
		<div class="row">
			...
			<div class="c9">
				...
				<center><span>List of Customer</span></center>
				</h1>
	...
	?>
		<tr>
			<td><input type="checkbox" name="delete[]" value="<?php echo $row["customer_id"]; ?>">
			<td><input type="text" name="ID" size="15" value="<?php echo $row["customer_id"]; ?>"  readonly  >
			<td><input type="text" name="UserName" size="20" value="<?php echo $row["customer_username"]; ?>" readonly>
			<td><input type="text" name="Name" value="<?php echo $row["customer_name"]; ?>" size="14" readonly>
			<td><input type="text" value="<?php echo $row["customer_address"]; ?>" name="Address" size="21" readonly>
			<td><input type="text" value="<?php echo $row["customer_phone"]; ?>"  name="Contact" size="18" readonly>
			<td><input type="text" value="<?php echo $row["customer_email"]; ?>" name="Email" size="23" readonly>
