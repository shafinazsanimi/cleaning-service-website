...
<div class="grid">
		...
		<div class="row">
			...
			<div class="c3">
				<div class="leftsidebar">
					...
					<?php
						...
						$result = mysqli_query($con, "select cleaner_username from cleaner");
						while($row=mysqli_fetch_assoc($result))	
					{?>
					<?php echo "Cleaner ID : " . $row["cleaner_username"]; ?>
					...
					cleaner 
					ON
					cleaner.cleaner_username = feedback_all.feedback_username AND cleaner.cleaner_username='$id'
					...
					while($row=mysqli_fetch_assoc($result))	
					{
					  echo "Cleaner Feedback : " . $row["feedback_id"] . "    " ; 
					}
					}
					?>
			...
			<div class="c9">
				...
				<span>Cleaner Feedback</span>
				</h1>
				<br/>
			
		<table>
		<tr>
		<th><center>Input Cleaner ID To List Out Feedback ID
