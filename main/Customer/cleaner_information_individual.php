...
function myFunction()
{
window.open("customer_summary_booking_In.html","_self");
}
</script>
		...
		<div class="row space-top space-bot">
			...
			<div class="c10" style="text-align:center;margin-top:50px;margin-bottom:130px;">
				...
				<div class="pageline">
					...
					<div class="container">
						<a href="#" onclick="myFunction()">
						<img src="image/c3.jpg" style="border-bottom: 5px solid #eee;" alt="" name="A"/></button>
							<div class="overlay">
								<div class="text">Price : RM60 </div>
							</div>
						</a>
