...
$username=$_COOKIE['username'];
	...
	if (isset($_POST["submit"]))
	{
		...
		mysqli_query($con, "INSERT INTO payment_ct (payment_username, payment_id, payment_amount, payment_account, payment_company)
		VALUES ('$username','$id','$amount','$account','$company')");
	}
?>
...
<div class="undermenuarea">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead">Customer Payment Sections </h1>
			</div>
			<div class="c4">
...
<div class="grid">
		...
		<div class="row space-top space-bot">
			...
			<div class="c10" style="text-align:center;margin-top:50px;margin-bottom:130px;">
				...
				<h1> <center><span>Customer Payment</span></h1></center>		
				<br/>
			...
			<pre align="left">
Your ID:    <input type="text" name="id" required="true" readonly Value="<?php echo $row["customer_username"];?>">

Amount:    <input type="text" name="amount" required="true" placeholder="Insert Amount Need to pay here">
 
Account:   <input type="text" name="account" required="true" placeholder="Insert Your account Number here">

Cleaner's Name:   <input type="text" name="company" required="true" placeholder="Insert Your Cleaner's Name here">
			</pre>
						<center><button id="submit" type="submit" onclick="myFunction()" required="true" name="submit"> Submit </center></button>
			

						<h2><center> Please Email Proof Payment to Cleaner's email </center></h2><br/>
			</div>
				<div class="c1">
				</div>
		</div>
