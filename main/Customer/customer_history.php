...
<div class="undermenuarea">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead">Customer History Sections</h1>
			</div>
			<div class="c4">
...
<div class="grid">
		...
		<div class="row">
			...
			<div class="c3">
				<div class="leftsidebar">
					<h2 class="title stresstitle">Customer Order</h2>
					<hr class="hrtitle">
					...
					<?php
						...
						$result = mysqli_query($con, "select customer_username from customer where customer_username='$username'");
					...
					customer 
					ON
					customer.customer_username = booking_username AND customer_username='$id'
	...
	?>
		...
		<?php echo " Name : " . $row["booking_name"]; ?>
	
	
		<?php echo " Address : " . $row["booking_address"]; ?>
	
	
		<?php echo " Phone : " . $row["booking_phone"]; ?>
	
	
		<?php echo " Email : " . $row["booking_email"]; ?>
