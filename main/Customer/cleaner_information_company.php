...
function myFunction()
{
window.open("customer_summary_booking_Co.html","_self");
}
</script>
...
<div class="undermenuarea">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead">Cleaner Area</h1>
			</div>
			<div class="c4">
...
<div class="grid">
		...
		<div class="row space-top space-bot">
			...
			<div class="c10" style="text-align:center;margin-top:50px;margin-bottom:130px;">
				<h1> Booking Form for Company Cleaner </h1>
				<div class="pageline">
					
					
					<span class="left"> <h6> Name : </h6> </span> 
					<input type="text" name="Username" placeholder="Enter SNV Cleaning " required="" /> </pre>
					...
					<select style="max-width:30%">
						...
						<option value="choice 1"> House Cleaning </option>
						<option value="choice 2"> Apartment Cleaning </option>
						<option value="choice 3"> Move in / Move out Cleaning </option>
					</select>
					
					<h6> Choose your Company </h6>
					<h6> ( Click on the Image To Submit ) </h6>
					
					<div class="container">
						<a href="#" onclick="myFunction()">
						<img src="image/c4.png"  style="border-bottom: 5px solid #eee;" alt="" name="A"/>
							<div class="overlay">
								<div class="text">Company Name : Indah Cleaning <br/> Price : RM180 </div>
							</div>
						</a>
					</div>		
					...
					<div class="container">
						<a href="#" onclick="myFunction()">
						<img src="image/c5.png"  style="border-bottom: 5px solid #eee;" alt="" name="B"/>
							<div class="overlay">
								<div class="text">Company Name : Lisa Cleaning <br/> Price : RM180 </div>
							</div>
						</a>
					</div>	
					...
					<div class="container">
						<a href="#" onclick="myFunction()">
						<img src="image/c6.jpg"  style="border-bottom: 5px solid #eee;" alt="" name="C"/></button>
							<div class="overlay">
								<div class="text">Company Name : Bubble Clean<br/> Price : RM180 </div>
							</div>
						</a>
					</div>
