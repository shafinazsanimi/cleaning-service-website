...
include("connectionDB.php");
   ...
   $variable;
	...
	if (isset($_POST["submit"]))
	{
		...
		mysql_query("insert into booking (booking_username, booking_name, booking_address, booking_email, booking_phone ,booking_company ,booking_date, booking_services) 
		values ('$username','$name','$address','$email','$phone','$company','$date','$services')");
	}
  ?>
		...
		<div class="row space-top space-bot">
			...
			<div class="c10" style="text-align:center;margin-top:50px;margin-bottom:130px;">
				...
				<form action="" method="post" >	
					...
					<div class="container">
						<label>
						<input  type='radio' name='company' value='cleaner4'/>
					...
					<div class="container">
						<label>
						<input type='radio' name='company' value='cleaner5' />
						<img src="image/c5.png" style="border-bottom: 5px solid #eee;" alt="" name="A"/>
					...
					<div class="container">
						<label>
						<input type='radio' name='company' value='cleaner6' />
						<img src="image/c6.jpg" style="border-bottom: 5px solid #eee;" alt="" name="A"/>
						</label>
					</div>
					<br/>
